...
const EmployerPost = () => {
    ...
    return <>
        <div className="container" style={{ marginTop: "20px",fontSize: '40px', textAlign: "center", background: "#78c2ad", color: "white", borderRadius:"20px 20px 0px 0px", margin:"20px auto"}}>Bài Đăng Tuyển Dụng</div>
        {body}
        <AddPostModal />
        <Toast
            show={show}
